...
void CopyArrayUsingAddArrayElement(int Array1[], int Array2[], int Array1Length,int& Array2Length) {
...
int main()
{
	...
	CopyArrayUsingAddArrayElement(Array1,Array2, Array1Length, Array2Length);
